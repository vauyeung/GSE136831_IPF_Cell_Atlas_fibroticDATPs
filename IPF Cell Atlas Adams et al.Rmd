...
## Assume that annotations are accurate
```{r}
...
```{r}
Idents(ipfatlas.epi.ipf.cells) <- ipfatlas.epi.ipf.cells[['Manuscript_Identity']]
...
MNN clustering focused on aT2 cells including DATPs, and Imran's P7 and P14 cells.

```{r}
load('D:/Users/vauyeung/Box Sync/lab/Datasets/210927_A00269_0565_AH3VL2DSX2/IRE1Bleo.Vel.withDev.MNN.AT2.cells.Robj')
```
